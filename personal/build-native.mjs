...
export async function buildNative() {
  ...
  if (process.platform === 'darwin') {
    await run('/usr/bin/swiftc', ['-parse-as-library', '-swift-version', '5', '-O', '-framework', 'AppKit', join(root, 'personal/native/PersonalDevSpaceTray.swift'), '-o', join(bin, 'personal-devspace-tray')]);
